          ...
          <div className="space-y-6">
            <div className="animate-fade-in">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                Shenzhen Tianyi Intelligent Technology Co., Ltd. (WODTOP) was established in December 2013. It is mainly engaged in the research and development, design, production, sales and service of FA (Factory Automation) factory automation precision parts, tooling and inspection jigs and automation equipment.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
